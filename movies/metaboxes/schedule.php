...
?>
	...
	<p>
		...
		<input type="text" name="early" value="<?=echo_var($meta['early'][0],$defaults_early)?>" placeholder="e.g. <?=echo_var($meta['early'][0],$defaults_early)?>"/>
		<label for="early">Early</label>
		<input type="text" name="late" value="<?=echo_var($meta['late'][0],$defaults_late)?>" placeholder="e.g. <?=echo_var($meta['late'][0],$defaults_late)?>"/>
		<label for="late">Late</label>
	</p>

	<p><span class="schedule-label">Matinees:</span>
	<input type="text" name="matinee" value="<?=echo_var($meta['matinee'][0],$defaults_matinee)?>" placeholder="e.g. <?=echo_var($meta['matinee'][0],$defaults_matinee)?>"/></p>
